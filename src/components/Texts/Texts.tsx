...
import { SOUND, ABOUTME, THREEDEE, IMAGE, EDUCATION, PROGRAMMING } from '../Main/Main';
...
const getText = () : ReactNode => {
  switch(props.id) {
    ...
    case ABOUTME : return([
      <p>Hi, I'm Antti, a communications specialist with a passion for board games, programming, and creative problem-solving. 
      I thrive on building interactive experiences, whether through code or game mechanics. 
      Beyond development, I enjoy playing floorball, exploring music, and diving into different forms of communication — from science outreach to social media engagement.</p>,
      <p>I'm always looking for new ways to blend technology, creativity, and communication to build meaningful experiences.</p>
    ])
    return <></>
  }
}
